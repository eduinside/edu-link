...
에듀링크는 대구광역시교육청 소속 교직원이 긴 URL을 짧고 기억하기 쉬운 주소로 변환하여 공유할 수 있도록 설계된 단축주소 서비스입니다. Cloudflare의 글로벌 엣지 네트워크 위에서 동작하며, 별도 서버 운영 없이 완전한 서버리스로 구현되었습니다.
...
- **OpenAPI v1** — API Key 발급 및 외부 시스템 연동 (Rate Limit: 분당 15회)
